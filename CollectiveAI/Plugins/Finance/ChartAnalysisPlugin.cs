...
public class ChartAnalysisPlugin
{
    ...
    {
        return
            $"{ticker} {timeframe} Levels: Strong Support: $142.50, $138.20, $135.00 | Resistance: $148.75, $152.30, $156.00 | Current: $145.80";
    }
    ...
    {
        return
            $"{ticker} Volume Analysis ({days}d): Avg Volume: 45.2M, Today: 62.3M (+38%), Accumulation detected, OBV trending up, Smart money buying";
    }
        ...
        [Description("Recent low")] double low)
    {
        ...
        return
            $"{ticker} Fibonacci Levels: 38.2%: ${fib382:F2}, 50%: ${fib50:F2}, 61.8%: ${fib618:F2} (Golden ratio - key level)";
    }
}